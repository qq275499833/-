    ...
    var app = new Vue({
        ...
        methods: {
            ...
            xs1:function () {
                this.mn1=!this.mn1;
                if(this.mn1==true){
                    $('.ic').css('background','url("/theme/new34/images/up.png")no-repeat');
                    $('.ic').css('background-size','27px');
                }else{
                    $('.ic').css('background','url("/theme/new34/images/down.png")no-repeat');
                    $('.ic').css('background-size','27px');
                }
            ...
            prompt(){
                ...
                if(this.show_prompt===true){
                    $('.gk').css('background','url("/theme/new34/images/up.png")95% no-repeat');
                    $('.gk').css('background-size','27px');
                }else{
                    $('.gk').css('background','url("/theme/new34/images/down.png")95% no-repeat');
                    $('.gk').css('background-size','27px');
                }
            },
        }
