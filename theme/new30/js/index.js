...
function loadData(data) {
    var app = new Vue({
        ...
        data: {
            ...
            active:data.detail.manyoff?JSON.parse(data.detail.manyoff)[0].salecount:"",
        ...
        created: function () {
            ...
            setInterval(this.doscroll1, 2000);
            setInterval(this.doscroll2, 2000);
            //选择城市
        ...
        mounted: function () {
            ...
            //判断manyoff起卖件数
            this.selectName(this.active,this.giftCount);
            if(window.location.href.indexOf('ordersearch')!==-1){
                this.expressinfo=window.location.href.split("=")[1];
                if(this.expressinfo){
                    this.find_order();
                }
            }
        ...
        methods: {
            ...
            goback:function(){
                ...
                if(url.indexOf("?")>-1&&(str === time+'')){
                    window.location.href = localStorage.getItem('url')+"?"+time;
                }else{
            ...
            //商品属性、动态添加class
            selectName:function (index,giftcount) {
                this.active=index;
            ...
            doscroll2(){
                var parent = $('#purchaseInfo');
                var first = parent.find('li:first');
                var height = parseInt(first.height())+20;
                first.animate({
                    marginTop: -height + 'px'
                }, 1000, function() {
                    first.css('marginTop', 0).appendTo(parent);
